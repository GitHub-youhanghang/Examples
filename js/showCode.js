    $(document).ready(function() {
        ...
        $('#srcBtn').on('click',function(){
            if (srcIsOpen) {
                ...
                $('body').removeClass('body-padding-right');
                  $('#codeBoxPosition').hide();
            }else{
                $(this).text('关闭源代码');
                 $('textarea').show();
                srcIsOpen=true;
                $('#codeBoxPosition').show();
                if (srcPosition=='right') {
                  $('#codeBoxPosition').text('源代码位置-右');
                  $('.showCodeBox').removeClass('right').addClass('bottom');
                  srcPosition='bottom';
                  $('body').removeClass('body-padding-right');
                }
            }
        ...
        $('#codeBoxPosition').on('click',function(){
            if (srcPosition=='bottom') {
                $(this).text('源代码位置-下');
                $('.showCodeBox').removeClass('bottom').addClass('right');
                srcPosition='right';
